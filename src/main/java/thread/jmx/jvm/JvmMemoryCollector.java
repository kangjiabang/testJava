...
public  class JvmMemoryCollector {
    ...
    public GcMemoryCollectorInfo getGcMemoryCollectInfo() {
        try {
            ...
            ObjectName edenHeapObjName = new ObjectName("java.lang:type=MemoryPool,name=PS Eden Space");
            ...
            ObjectName oldHeapObjName = new ObjectName("java.lang:type=MemoryPool,name=PS Old Gen");
            ...
            ObjectName metaHeapObjName = new ObjectName("java.lang:type=MemoryPool,name=Metaspace");
