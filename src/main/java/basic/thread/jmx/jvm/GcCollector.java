...
public  class GcCollector {
    ...
    public GcCollector(MBeanServerConnection mbsc) {
        this.mbsc = mbsc;
    }
    ...
    public GcCollectorInfo getGcCollectInfo() {
        try {
            ...
            ObjectName oldThreadObjName = new ObjectName("java.lang:basic.type=GarbageCollector,name=PS MarkSweep");
           ...
           /* System.out.println("fullGcCount: " + fullGcCount);
            ...
            ObjectName youngThreadObjName = new ObjectName("java.lang:basic.type=GarbageCollector,name=PS Scavenge");
